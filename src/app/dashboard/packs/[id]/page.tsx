  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div>
        ...
        <div className="mt-3 overflow-hidden rounded-2xl border border-violet-100 bg-gradient-to-br from-violet-50 to-white p-5 shadow-sm sm:p-6">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {chips.map((c) => (
                  <span
                    key={c}
                    className="inline-flex items-center rounded-full bg-white px-2.5 py-0.5 text-xs font-medium text-zinc-600 ring-1 ring-inset ring-zinc-200"
                  >
                    {c}
                  </span>
                ))}
